...
class EdifyGenerator(object):
  ...
  def PrintPixelExperienceBanner(self, is_plus, android_version, lit_version, build_id, build_date,
                                  security_patch, device):
    self.Print("----------------------------------------------")
    if is_plus:
      self.Print("               LitmusOS")
      self.Print("                by Litmus Team")
    else:
      self.Print("              LitmusOS")
      self.Print("              by Litmus Team")
    self.Print("----------------------------------------------")
    self.Print(" Android version: %s"%(android_version))
    self.Print(" LitmusOS version: %s"%(lit_version))
